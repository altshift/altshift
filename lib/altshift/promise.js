...
Promise = core.class('Promise', {
    extend: {
         ...
         */
        serial: function (array, startingValue) {
    ...
    and: function (values) {
        values = Array.isArray(values) ? values.slice() : Array.prototype.slice.call(arguments);
        values.unshift(this);
 ...
 * </pre>
 ******************************************************************************/
Deferred = core.class('Deferred', Promise, {
...
var serial = function (array, startingValue) {
    return Promise.serial.apply(Promise, arguments);
};
