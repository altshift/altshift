...
var Finder = core.class('Finder', {
     ...
     */
    names: function () {
        var patterns = Array.isArray(arguments[0]) ? arguments[0].slice() : Array.prototype.slice.call(arguments);
        this._names = patterns.map(function (pattern) {
            if (typeof(pattern) !== 'string' && !(pattern instanceof RegExp)) {
                throw new Error(pattern.toString() + ' should be a string or RegExp');
            }
    ...
    notNames: function () {
        var patterns = Array.isArray(arguments[0]) ? arguments[0].slice() : Array.prototype.slice.call(arguments);
        this._namesNot = patterns.map(function (pattern) {
            if (typeof(pattern) !== 'string' && !(pattern instanceof RegExp)) {
                throw new Error(pattern.toString() + ' should be a string or RegExp');
            }
            return _toRegExp(pattern);
     ...
     */
    exclude: function () {
        var patterns = Array.isArray(arguments[0]) ? arguments[0] : Array.prototype.slice.call(arguments);
        this._excludes = patterns.map(function (pattern) {
            if (typeof(pattern) !== 'string' && !(pattern instanceof RegExp)) {
                throw new Error(pattern.toString() + ' should be a string or RegExp');
            }
            return _toRegExp(pattern);
    ...
    fetch: function (directories, callback) {
        ...
        onWalk = function (error, files) {
            ...
            if (onWalkCount <= 0 && callback) {
                results = results.filter(self._postFilter, self);
    ...
    fetchSync: function (directories) {
        ...
        directories.forEach(function (directory) {
            ...
            directoryResult = directoryResult.filter(self._postFilter, self);
