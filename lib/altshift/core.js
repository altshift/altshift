 ...
 * Imports
 */
var jsclass = require('altshift/js-class');
exports = jsclass;
...
var _module = function (name, methods, options) {
    return new jsclass.Module(name, methods, options);
};
...
var _class = function (name, parent, methods) {
    if (! name || typeof(name) !== 'string' || name.length === 0) {
        throw new exports.ValueError({message: 'name should not be empty'});
    }
    ...
    return new jsclass.Class(name, parent, methods);
};
...
var _interface = function (name, methods) {
    return new jsclass.Interface(name, methods);
};
 ...
 *
 ******************************************************************************/
var BaseException = _class('BaseException', {
 ...
 * SystemExit Class
 ******************************************************************************/
var SystemExit = _class('SystemExit', BaseException, {
    code: 'exit',
 ...
 ******************************************************************************/
var KeyboardInterrupt = _class('KeyboardInterrupt', BaseException, {
    code: 'keyboard',
 ...
 * Exception Class
 ******************************************************************************/
var Exception = _class('Exception', BaseException, {
    code: 'exception',
 ...
 * StopIteration Class
 ******************************************************************************/
var StopIteration = _class('StopIteration', BaseException, {
    code: 'iteration',
 ...
 * Error Class
 ******************************************************************************/
exports.Error = _class('Error', Exception, {
    code: 'error',
 ...
 ******************************************************************************/
var AssertionError = _class('AssertionError', exports.Error, {
    code: 'assertion',
 ...
 * RuntimeError Class
 ******************************************************************************/
var RuntimeError = _class('RuntimeError', exports.Error, {
    code: 'runtime',
 ...
 ******************************************************************************/
var NotImplementedError = _class('NotImplementedError', RuntimeError, {
    code: 'implementation',
 ...
 * SystemError Class
 ******************************************************************************/
var SystemError = _class('SystemError', exports.Error, {
    code: 'system',
 ...
 * TypeError Class
 ******************************************************************************/
exports.TypeError = _class('TypeError', exports.Error, {
    code: 'type',
 ...
 * ValueError Class
 ******************************************************************************/
var ValueError = _class('ValueError', exports.Error, {
    code: 'value',
 ...
 * LookupError Class
 ******************************************************************************/
var LookupError = _class('LookupError', exports.Error, {
 ...
 * IndexError Class
 ******************************************************************************/
var IndexError = _class('IndexError', LookupError, {
    code: 'index',
 ...
 * KeyError Class
 ******************************************************************************/
var KeyError = _class('KeyError', LookupError, {
    code: 'key',
...
//Warnings
var Warning = _class('Warning', Exception, {
    message: 'Warning throwed'
}).export(module);

var DeprecationWarning = _class('DeprecationWarning', Warning, {
    message: 'Deprecation warning throwed'
}).export(module);

var SyntaxWarning = _class('SyntaxWarning', Warning, {
    message: 'Syntax warning throwed'
}).export(module);

var RuntimeWarning = _class('RuntimeWarning', Warning, {
    message: 'Runtime warning throwed'
}).export(module);

var UserWarning = _class('UserWarning', Warning, {
