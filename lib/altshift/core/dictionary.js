 ...
 *
 * hash.extend({foo: 'new text', baz: 'new key'})
...
var Dictionary = new klass.Class('Dictionary', {
    ...
    clone: function (deep) {
        if (deep) {
            ...
            return (new Dictionary()).extend(this);
        }
    },
     ...
     * @return this
     */
    extend: function (objectExtension) {
    ...
    map: function (iterator, thisp) {
        ...
        var result = new Dictionary(), property, keyValue, key, value;
